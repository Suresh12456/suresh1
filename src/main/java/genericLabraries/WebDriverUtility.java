...
public class WebDriverUtility {     
	...
	private WebDriver driver;
      ...
      */
      ...
      /**
       * This method is used to navigate to specific application
       * @param url 
       */
       ...
       /**
        * This method is used to wait until element or list of element or list of element is found 
        * @param time
        */
       ...
       /**
        * This method is used to frame based on id or name attribute
        * @param idOrName
        */
        ...
        */
		...
		/**
		 * This method handles alter pop up
		 * @param status
		 */
		...
		/**
		 * This method is used to close all the tabs or window
		 */
